...
public class MyActivity extends BaseActivity {
    ...
    @BindView(R.id.tx_take_photo)
    TextView txTakePhoto;
    @BindView(R.id.tx_take_img)
    TextView txTakeImg;
    @BindView(R.id.iv)
    ImageView iv;
    ...
    @OnClick({R.id.tx_take_photo, R.id.tx_take_img})
    public void setImg(View view) {
        switch (view.getId()) {
            case R.id.tx_take_photo:
                openCamera();//打开相机
                break;
            case R.id.tx_take_img:
    ...
    private void openCamera() {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            imageUri = FileProvider.getUriForFile(this, "com.example.mayn.basetools.fileprovider", outputImage);
        }
        // 启动相机程序
