...
public class CommonHeader extends FrameLayout implements PtrUIHandler {
    ...
    private CommonHeader.LastUpdateTimeUpdater mLastUpdateTimeUpdater = new CommonHeader.LastUpdateTimeUpdater();
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.ui_refresh_header, this);

        mRotateView = header.findViewById(R.id.refRotate);

        mTitleTextView = (TextView) header.findViewById(R.id.refTitle);
        mLastUpdateTextView = (TextView) header.findViewById(R.id.refLastDate);
        mProgressBar = header.findViewById(R.id.refProgress);
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.ptr_pull_to_refresh));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.ptr_pull_to_refresh));
        }
    }
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(getResources().getString(R.string.ptr_updated));
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(R.string.ptr_pull_to_refresh);
        }
    }
