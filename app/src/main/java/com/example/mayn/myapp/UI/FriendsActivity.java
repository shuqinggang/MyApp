...
import com.example.mayn.myapp.MlogUtils.MyDialog;
...
public class FriendsActivity extends BaseActivity implements MyDialog.CliclText{
    public static final int TAKE_PHOTO = 4;//拍照
    public static final int CHOOSE_PHOTO = 5;//选择相册
    public static final int PICTURE_CUT = 6;//剪切图片
    ...
    MyDialog myDialog;
    //图片相册多选择地址https://github.com/DickyQie/android-advanced-effect
    @Override
    ...
    public void takePhotoss(){
        myDialog=new MyDialog(this);
        myDialog.setCliclText(this);
        myDialog.show();
    }
